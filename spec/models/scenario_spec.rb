...
describe Scenario do
  ...
  describe "validations" do
    ...
    it "validates the presence of name" do
      new_instance.name = ''
      new_instance.data = {name: "testscenario", guid: "someguid", agents: [{name: "testagent", type: "testtype" }]}.to_json
    ...
    it "validates data is a valid Scenario " do
      new_instance.data = {agents: [{name: "testagent", type: "testtype" }]}.to_json
      expect(new_instance).not_to be_valid
    end

    it "validates data['agents'] is an array" do
      new_instance.data = {name: "testscenario", guid: "someguid", agents: "test"}.to_json
      expect(new_instance).not_to be_valid
    end
    ...
    it "validates data['agents'] array contains valid agents" do
      new_instance.data = {name: "testscenario", guid: "someguid", agents: [{name: "testagent"}]}.to_json
      expect(new_instance).not_to be_valid
    end
